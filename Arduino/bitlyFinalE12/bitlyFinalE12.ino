...
void setup() {
  ...
  Ethernet.begin(mac, IPAddress(192,168,2,5));
  delay(200);
  ...
  for (int i = 0; i < 324; i++) {
    leds[i] = CRGB(124,252,0);
  }
  for (int i = 324; i < 648; i++) {
    leds[i] = CRGB(255,218,185);
  }
  FastLED.show();
}
